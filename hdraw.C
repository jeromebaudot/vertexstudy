...
#include <TCanvas.h>
    ...
    TH1F *h1_e_RInter = new TH1F("h1_e_RInter", "Number of recontructible charged particles/Event;Nb of reconstructible charged particles", 28, 0, 28); //Reconstructible
    ...
    TH1F *h1_v_RInter = new TH1F("h1_v_RInter", "Number of reconstructible intermediate particles/Vertex;Nb of particles", 20, 0, 20);
